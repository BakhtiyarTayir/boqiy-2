...
class AdminCrudController extends Controller
{
	...
	public function user_edit($id = "")
	{
		...
		$page_data['like_balance'] = $userData->likeBalance;
		$page_data['wallet_balance'] = $userData->wallet;
	...
	public function user_update($id = "", Request $request)
	{
		...
		LikeBalance::where('id', $likeBalance->id)->update([
			'balance' => $request->likeBalance
		]);
		
		$walletBalance = $user->wallet;
		
		Wallet::where('id', $walletBalance->id)->update([
