<div class="main_content">
        ...
        <div class="col-12">
            <div class="eSection-wrap-2">
                <div class="eForm-layouts">
                    <form method="POST" action="{{ route('admin.about.page.data.update', $about->setting_id) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3 mt-2">
                            <label for="about"
                                class="form-label eForm-label mt-1">{{ get_phrase('About Page Description') }}</label>
    ...
    <div class="row mt-5">
        <div class="col-12">
            <div class="eSection-wrap-2">
                <div class="eForm-layouts">
                    <form method="POST" action="{{ route('admin.privacy.page.data.update', $privacy->setting_id) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="privacy"
                                class="form-label eForm-label">{{ get_phrase('Privacy Page Description') }}</label>
        ...
        <div class="row mt-5">
            <div class="col-12">
                <div class="eSection-wrap-2">
                    <div class="eForm-layouts">
                        <form method="POST" action="{{ route('admin.term.page.data.update', $term->setting_id) }}"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group mb-3">
                                <label for="term"
                                    class="form-label eForm-label">{{ get_phrase('Term and Condition Page Description') }}</label>
