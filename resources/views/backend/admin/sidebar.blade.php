<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li class="nav-links-li @if (Route::currentRouteName() == 'admin.view.category' ||
                ...
                Route::currentRouteName() == 'admin.users.accountActiveReq') showMenu @endif">
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
            ...
            <ul class="sub-menu">
                ...
                @else
                    <a class="@if (Route::currentRouteName() == 'admin.users.accountActiveReq') Active @endif"
                       href="{{ route('admin.users.accountActiveReq') }}">{{ get_phrase('Account Active Request') }}</a></li>
                @endif
            </ul>
        </li>
        ...
        <li class="nav-links-li @if (
                ...
                Route::currentRouteName() == 'admin.marketplace.order.show') showMenu @endif">
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
            ...
            <ul class="sub-menu">
                <li>
                    <a class="@if (Route::currentRouteName() == 'admin.marketplace.products' ||
                                Route::currentRouteName() == 'admin.marketplace.products.show' ||
                                Route::currentRouteName() == 'admin.marketplace.products.edit') Active @endif"
                       href="{{ route('admin.marketplace.products') }}">{{ get_phrase('Products') }}</a>
                </li>
                <li>
                ...
                <li>
                    <a class="@if (Route::currentRouteName() == 'admin.marketplace.products.featured') Active @endif"
                       href="{{ route('admin.marketplace.products.featured') }}">{{ get_phrase('Active Products') }}</a>
                </li>
                <li>
                    <a class="@if (Route::currentRouteName() == 'admin.marketplace.products.out-of-stock') Active @endif"
                       href="{{ route('admin.marketplace.products.out-of-stock') }}">{{ get_phrase('Out of Stock Products') }}</a>
                </li>
                <li>
                    <a class="@if (Route::currentRouteName() == 'admin.marketplace.orders' ||
                                Route::currentRouteName() == 'admin.marketplace.order.show') Active @endif"
                       href="{{ route('admin.marketplace.orders') }}">{{ get_phrase('Orders') }}</a>
                </li>
                <li>
                    <a class="@if (Route::currentRouteName() == 'admin.marketplace.orders.pending') Active @endif"
                       href="{{ route('admin.marketplace.orders.pending') }}">{{ get_phrase('Pending Orders') }}</a>
                </li>
                <li>
                    <a class="@if (Route::currentRouteName() == 'admin.marketplace.statistics') Active @endif"
                       href="{{ route('admin.marketplace.statistics') }}">{{ get_phrase('Sales Statistics') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-links-li @if (Route::currentRouteName() == 'admin.about.page.data.view' ||
            ...
            <ul class="sub-menu">
                ...
                <li><a class="@if (Route::currentRouteName() == 'admin.import.translations') Active @endif"
                       href="{{ route('admin.import.translations') }}">{{ get_phrase('Import Translations') }}</a></li>
