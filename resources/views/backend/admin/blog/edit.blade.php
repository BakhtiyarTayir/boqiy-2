            ...
            <div class="eForm-layouts">
              ...
              <form method="POST" action="{{ route('admin.blog.created') }}" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control eForm-control py-1" id="tag" value="@foreach(json_decode($blog_details->tag, true) as $tag) {{$tag}}, @endforeach" name="tag" placeholder="Tags">
                  </div>
