<div class="page-wrap">
    <div class="d-flex pagetab-head video_wrap_title   align-items-center justify-content-between mb-3 p-20 radius-8 bg-white">
        <h3 class="h5 mb-0"><span><i class="fa-solid fa-file-video"></i></span> {{ get_phrase('Watch') }}</h3>
        <div class="w-80 gap_10">
            ...
            <a href="{{ route('shorts') }}" class="btn @if(Route::currentRouteName() == 'shorts') common_btn_2 @else common_btn @endif "><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M1.33398 5.23999V10.7933C1.33398 13.22 2.78065 14.6667 5.20732 14.6667H10.794C13.2207 14.6667 14.6673 13.22 14.6673 10.7933V5.23999H1.33398ZM9.62732 10.7867L8.24065 11.5867C7.94732 11.7533 7.66065 11.84 7.39398 11.84C7.19398 11.84 7.01398 11.7933 6.84732 11.7C6.46065 11.48 6.24732 11.0267 6.24732 10.44V8.83999C6.24732 8.25332 6.46065 7.79999 6.84732 7.57999C7.23398 7.35332 7.72732 7.39332 8.24065 7.69332L9.62732 8.49332C10.1406 8.78666 10.4207 9.19999 10.4207 9.64666C10.4207 10.0933 10.134 10.4867 9.62732 10.7867Z" fill="#0D091D"/>
                <path d="M5.17992 1.33334C3.11326 1.34001 1.75992 2.40668 1.41992 4.24001H5.17992V1.33334Z" fill="#0D091D"/>
                </svg>{{get_phrase('Shorts')}}</a>
            <a href="{{ route('videos') }}" class="btn @if(Route::currentRouteName() == 'videos') common_btn_2 @else common_btn @endif "><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.0993 4.11332C13.826 3.96666 13.2527 3.81332 12.4727 4.35999L11.4927 5.05332C11.4193 2.97999 10.5193 2.16666 8.33268 2.16666H4.33268C2.05268 2.16666 1.16602 3.05332 1.16602 5.33332V10.6667C1.16602 12.2 1.99935 13.8333 4.33268 13.8333H8.33268C10.5193 13.8333 11.4193 13.02 11.4927 10.9467L12.4727 11.64C12.886 11.9333 13.246 12.0267 13.5327 12.0267C13.7793 12.0267 13.9727 11.9533 14.0993 11.8867C14.3727 11.7467 14.8327 11.3667 14.8327 10.4133V5.58666C14.8327 4.63332 14.3727 4.25332 14.0993 4.11332ZM7.33268 7.58666C6.64602 7.58666 6.07935 7.02666 6.07935 6.33332C6.07935 5.63999 6.64602 5.07999 7.33268 5.07999C8.01935 5.07999 8.58602 5.63999 8.58602 6.33332C8.58602 7.02666 8.01935 7.58666 7.33268 7.58666Z" fill="#0D091D"/>
                </svg>{{get_phrase('Videos')}}</a>
            <a href="{{ route('save.all.view') }}"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="Saved Video"><span class=" @if(Route::currentRouteName() == 'save.all.view') common_btn_2 @else common_btn @endif "><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-md-6 col-lg-6 col-sm-12">
                    <div class="entry-text sav_text">
                        ...
                        <div class="d-flex my-2">
                            <!-- Avatar -->
                            <div class="avatar save_avater">
                                <a href="#!"><img class="avatar-img rounded-circle h-39" src="{{ get_user_image($video->getVideo->getUser->photo,'optimized') }}"
                                        alt="" ></a>
                            </div>
