        ...
        <div class="single-item-countable single-entry lenta-posts" id="postIdentification{{ $post->post_id }}" data-post-id="{{ $post->post_id }}" data-post-animation="{{ $post->post_animation }}">
            <div class="entry-inner">
                    ...
                    <div class="ava-info d-flex align-items-center">
                        ...
                        @elseif (isset($type) && $type == 'user_post')
                            ...
                            <div class="eUserFeature">
                                ...
                                {{-- New Hover Profile  --}}
                                @if(!empty($user) && $user->id != $post->user_id)
                                    <div class="hoverFeature">
                                        <div class="h_top">
                                            <div class="h_eImage">
                                                <img src="{{ get_user_image($post->user_id, 'optimized') }}">
                ...
                <div class="entry-content pt-2">
                    ...
                    @if ($isShowLikeBalanceModal && !empty($likes) && count($likes))
                        <div id="post-gift-like-list-{{ $post->post_id }}" class="like-boxes d-none">
                            @foreach($likes as $like)
                                <div class="like-item" onclick="sendLike({{ $post->post_id }}, {{ $like->id }}, {{ $like->price }})">
                                    <span class="amount">{{ $like->price }}</span>
                                    <span class="label">{{ $like->name }}</span>
                                </div>
                            @endforeach
                    ...
                    <div class="entry-footer">
                        ...
                        <div class="footer-share d-flex justify-content-around">
                            ...
                            @if (!empty($user))
                                ...
                                @if ($isShowLikeBalanceModal)
                                        <a href="#" class="gift-button btn-gift-like" data-gift-id="post-gift-like-list-{{ $post->post_id }}">
                                    ...
                                    @if (0)
                                    <!-- Likes panel -->
                                        <div id="likes-panel-{{ $post->post_id }}" class="likes-panel">
                                        <div class="likes-panel-header">
                                            <h5>{{ get_phrase('Select a gift') }}</h5>
                                        </div>
                                        <div class="likes-grid">
                                            ...
                                            @foreach($likes as $like)
                                                <div class="like-item test evesrvfwevev "
                                                     onclick="sendLike({{ $post->post_id }}, {{ $like->id }}, {{ $like->price }})"
                                                >
                                                    <span class="like-price">{{ $like->price }}</span>
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                                ...
                                <li><a href="javascript:void(0)"
                                       onclick="myReact('post', 'like', 'update', {{ $post->post_id }})">
                                        @if (0)
                                            <img src="{{ asset('storage/images/like.svg') }}" alt="Like" >
                                        @endif
                                        <span style="margin-right: 1px;"> <i class="far fa-thumbs-up"></i></span>
                                    </a>
                                </li>
                                <li><a href="javascript:void(0)" onclick="myReact('post', 'love', 'update', {{ $post->post_id }})">
                                        <img src="{{ asset('storage/images/love.svg') }}" alt="Love" style="width: 30px; margin-top: 2px;"></a>
                                </li>
                                <li><a href="javascript:void(0)"
                                ...
                                <li>
                                    <a href="javascript:void(0)" onclick="myReact('post', 'angry', 'update', {{ $post->post_id }})">
                                        <img src="{{ asset('storage/images/angry.svg') }}" alt="Angry"></a>
                                </li>
                            </ul>
                            </span>
            ...
            <div class="user-comments s_comment d-hidden bg-white" id="user-comments-{{ $post->post_id }}">
                ...
                <div class="comment-form d-flex pb-3 align-items-start">
                    @if (!empty($user))
                        <img src="{{ get_user_image($user->photo, 'optimized') }}" alt=""
                    ...
                    <form action="javascript:void(0)" class="w-100 ms-2 d-flex align-items-center position-relative post-form" method="post">
                        ...
                        <span type="button" class="position-absolute end-0"
                              ...
                              onclick="postComment(this, 0, {{ $post->post_id }}, 0,'post', true);" rows="1">
...
@include('modals.redirectLikeBalanceModal')
