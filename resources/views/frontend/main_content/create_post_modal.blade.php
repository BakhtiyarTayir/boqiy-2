        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <textarea name="description" class="n_textarea" id="post_article"
                    placeholder="{{ get_phrase("What did you learn today ____", [auth()->user()->name]) }}?"></textarea>
                         ...
                         <div class="add_post_modal">
                             <p class="mb-0">{{get_phrase('Add to your post')}}</p>
                                ...
                                <button type="button" onclick="loadMaps('map')" data-tab="tab-location"
                                    class="btn btn-secondary m_btn" style="display: none;"><img src="{{ asset('storage/images/location.png') }}"
                                        alt="photo"></button>
...
@include('frontend.main_content.likes_limit_modal')
