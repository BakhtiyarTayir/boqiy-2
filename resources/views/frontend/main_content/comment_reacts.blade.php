...
@if(!empty($user) && isset($my_react) && $my_react == true)
    @if(array_key_exists($user->id, $user_comment_reacts))
        @if($user_comment_reacts[$user->id] == 'like')
