...
@if(!empty($userData) && isset($post_react) && $post_react == true)
...
@if(!empty($userData) && isset($ajax_call) && $ajax_call)
    <!--hr tag will be split by js to show different sections-->
    <hr>
@endif

@if (!empty($userData) && isset($my_react) && $my_react == true)
    @if(array_key_exists($userData->id, $user_reacts))
        @if($user_reacts[$userData->id] == 'like')
        ...
        @if($user_reacts[$userData->id] == 'love')
        ...
        @if($user_reacts[$userData->id] == 'haha')
            <div class="sad-color">
        ...
        @if($user_reacts[$userData->id] == 'angry')
        ...
        @if($user_reacts[$userData->id] == 'sad')
            <div class="sad-color">
