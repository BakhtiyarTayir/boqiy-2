            ...
            <nav class="menu-wrap">
                <ul>
                    <li class="@if (Route::currentRouteName() == 'timeline' || Route::currentRouteName() == 'single.post') active @endif">
                        <a href="{{ route('timeline') }}"><img
                                src="{{ asset('storage/images/timeline-2.svg') }}"
                                alt="Timeline">{{ get_phrase('Timeline') }}
                        </a>
                    </li>
                    <li class="@if (Route::currentRouteName() == 'wallet.index' || Route::currentRouteName() == 'wallet.transactions') active @endif">
                        <a href="{{ route('wallet.index') }}">
                            ...
                            @if (!empty($userWallet))
                                ...
                                <span style="margin-left: 1rem"> {{ $userWallet->balance }} </span>
                            @else
                    ...
                    @if (!empty($user))
                        <li class="@if (
                            ...
                            active
@endif">
                            <a href="{{ route('like_balance.index') }}">
                                <span style="margin-right: 0.5rem"><i class="fas fa-thumbs-up fa-lg text-primary"> </i></span>
                                {{ get_phrase('Like Balance') }}
                                <span style="margin-left: 0.5rem">
                                    {{ $userLikeBalance ? $userLikeBalance->balance : 0 }}
                                </span>
                            </a>
                        </li>
                        ...
                        @if (0)
                            <li class="@if (Route::currentRouteName() == 'groups' ||
                                    ...
                                    Route::currentRouteName() == 'single.group.photos') active @endif"><a href="{{ route('groups') }}"><img
                                        ...
                                        alt="Group">{{ get_phrase('Group') }}</a>
                            </li>
                        @endif
                    @endif
                    <li class="element-pulse @if (Route::currentRouteName() == 'allproducts' ||
