...
<div class="profile-wrap">
    <div class="profile-cover  bg-white">
        <div class="profile-header" style="background-image: url('{{ route('showUserPhoto', $user_info->id) }}'); height: 300px">
        ...
        <div class="n_profile_tab">
            <div class="n_main_tab">
                <div class="profile-avatar d-flex align-items-center">
                    <div class="avatar avatar-xl"><img class="rounded-circle"
                                                       src="{{ route('showUserPhoto', $user_info->id) }}" alt=""></div>
            ...
            <nav class="profile-nav">
                <ul class="nav align-items-center justify-content-start">
                    ...
                    <li class="nav-item @if (Route::currentRouteName() == 'profile.savePostList') active @endif">
                        <a href="{{ route('profileEdit', ['id' => auth()->user()->id]) }}" class="nav-link">{{ get_phrase('Edit') }}</a>
                    </li>
    ...
    <div class="profile-content mt-3">
        <div class="row gx-3">
            <div class="col-lg-12 col-sm-12">
                ...
                @elseif(Route::currentRouteName() == 'profileEdit')
                    @include('frontend.profile.editProfile')
