...
<div class="row gx-3">
    <div class="col-lg-12">
        <div class="group-inner n_group bg-white  p-3">
            <div class="gr-search">
                <h3 class="h6"><span><i class="fa-solid fa-users"></i></span>{{ get_phrase('Group') }} </h3>
                <form action="{{ route('search.group') }}" class="ag_form" method="GET">
            ...
            <div class="page-suggest mt-4">
                ...
                <div class="ps-wrap mt-3 justify-content-between">
                    <div class="row">
                        @foreach ($groups as $group)
                            {{-- <div class="col-md-6 col-lg-12 col-xl-12 col-sm-4 col-6"> --}}
                                <div class="card eg_card p-2">

                                  <div class="card-head">
                                    <a href="{{ route('single.group',$group->id) }}"><img src="{{ get_group_logo($group->logo,'logo') }}" alt=""></a>
                                  </div>
                ...
                @if (count($groups)>15)
                    <a href="{{ route('all.group.view') }}" class="btn common_btn btn-lg d-block mt-3">{{ get_phrase('See More') }}</a>
                @endif
            </div>
        </div>
...
@else
<div class="no_data j_nodata bg-white radius-8 p-20">
