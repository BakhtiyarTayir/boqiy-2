                    ...
                    @endphp
                      <div class="single-suggest d-flex justify-content-between align-items-center">
                        <div
                            ...
                            <img class="user-round h-39" width="40" src="{{get_user_image($going_user_details->photo, 'optimized')}}" alt="">
                            <h3 class="h6 ms-2"><a href="#"></a>
                                {{ $going_user_details->name }}
                            </h3>
                        </div>
                        <span class="btn common_btn_2 py-2 px-4">{{ get_phrase('Going') }}</span>
                    </div> 
                @endforeach
                   ...
                   @php  
                    ...
                    @endphp
                      <div class="single-suggest d-flex justify-content-between align-items-center">
                        <div
                            class="suggest-avatar d-flex justify-content-between align-items-center">
                            <img class="user-round h-39" width="40" src="{{get_user_image($interested_user_details->photo, 'optimized')}}" alt="">
                            <h3 class="h6 ms-2"><a href="#"></a>
                                {{ $interested_user_details->name }}
                            </h3>
                        </div>
                        <span class="btn common_btn_2 py-2 px-4">{{ get_phrase('Interested') }}</span>
                    </div> 
                @endforeach
            </div>
        </div>
