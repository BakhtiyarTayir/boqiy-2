            ...
            <nav class="menu-wrap">
                <ul>
                    <li class="<?php if(Route::currentRouteName() == 'timeline' || Route::currentRouteName() == 'single.post'): ?> active <?php endif; ?>">
                        <a href="<?php echo e(route('timeline')); ?>"><img
                                src="<?php echo e(asset('storage/images/timeline-2.svg')); ?>"
                                alt="Timeline"><?php echo e(get_phrase('Timeline')); ?>

                        </a>
                    </li>
                    <li class="<?php if(Route::currentRouteName() == 'wallet.index' || Route::currentRouteName() == 'wallet.transactions'): ?> active <?php endif; ?>">
                        <a href="<?php echo e(route('wallet.index')); ?>">
                            <span style="margin-right: 0.5rem;">
                                <i class="fas fa-wallet text-primary fa-lg" ></i>
                            </span>
                            <?php echo e(get_phrase('Wallet')); ?>

                            
                            <?php if(!empty($userWallet)): ?>
                                
                                <span style="margin-left: 1rem"> <?php echo e($userWallet->balance); ?> </span>
                            <?php else: ?>
                                <span style="margin-left: 1rem"> 0 </span>
                            <?php endif; ?>
                        </a>
                    </li>
                    ...
                    <?php if(!empty($user)): ?>
                        <li class="<?php if(
	                                    Route::currentRouteName() == 'like_balance.index'
	                                    || Route::currentRouteName() == 'like_balance.transactions'
	                               ): ?>
                            active
<?php endif; ?>">
                            <a href="<?php echo e(route('like_balance.index')); ?>">
                                <span style="margin-right: 0.5rem"><i class="fas fa-thumbs-up fa-lg text-primary"> </i></span>
                                <?php echo e(get_phrase('Like Balance')); ?>

                                <span style="margin-left: 0.5rem">
                                    <?php echo e($userLikeBalance ? $userLikeBalance->balance : 0); ?>
                        ...
                        <?php if(0): ?>
                            <li class="<?php if(Route::currentRouteName() == 'groups' ||
                                    ...
                                    Route::currentRouteName() == 'single.group.photos'): ?> active <?php endif; ?>"><a href="<?php echo e(route('groups')); ?>"><img
                                        ...
                                        alt="Group"><?php echo e(get_phrase('Group')); ?></a>
                            </li>
                        <?php endif; ?>
                    <?php endif; ?>
                    <li class="element-pulse <?php if(Route::currentRouteName() == 'allproducts' ||
                            Route::currentRouteName() == 'userproduct' ||
                            Route::currentRouteName() == 'single.product' ||
                            Route::currentRouteName() == 'filter.product' ||
                            Route::currentRouteName() == 'product.saved'): ?> active <?php endif; ?>">
                        <a href="<?php echo e(!empty($user) ? route('allproducts')  : route('noLoginProduct')); ?>">
                            <span style="margin-right: 0.5rem;"> <i class="fas fa-store element-pulse text-primary fa-lg" ></i></span>
                            <?php echo e(get_phrase('Marketplace')); ?>

                        </a>
                    </li>
                    <li class="element-pulse2 <?php if(Route::currentRouteName() == 'allProductsForSponsor' || Route::currentRouteName() == 'sponsorProductView'): ?> active <?php endif; ?>">
                        <a href="<?php echo e(!empty($user) ? route('allProductsForSponsor')  : route('noLoginProduct')); ?>">
                            <img src="<?php echo e(asset('/assets/frontend/images/support.png')); ?>" width="30" alt="homiylik">
                            <?php echo e(get_phrase('Homiylik')); ?>
...
<?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/frontend/left_navigation.blade.php ENDPATH**/ ?>