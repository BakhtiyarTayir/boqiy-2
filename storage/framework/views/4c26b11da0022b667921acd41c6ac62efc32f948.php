...
<?php if(!empty($user) && isset($my_react) && $my_react == true): ?>
    <?php if(array_key_exists($user->id, $user_comment_reacts)): ?>
        <?php if($user_comment_reacts[$user->id] == 'like'): ?>
        ...
        <?php if($user_comment_reacts[$user->id] == 'love'): ?>
        ...
        <?php if($user_comment_reacts[$user->id] == 'haha'): ?>
        ...
        <?php if($user_comment_reacts[$user->id] == 'angry'): ?>
        ...
        <?php if($user_comment_reacts[$user->id] == 'sad'): ?>
    ...
    <?php endif; ?>
<?php endif; ?><?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/frontend/main_content/comment_reacts.blade.php ENDPATH**/ ?>