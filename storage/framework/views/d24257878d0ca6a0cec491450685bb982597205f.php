    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo e(get_phrase('Loading...')); ?></h5>
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-center py-5">
                    <div class="spinner-border m-5" role="status">
                        <span class="visually-hidden"><?php echo e(get_phrase('Loading...')); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h5 class="modal-title"><?php echo e(get_phrase('Stories')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"
                    aria-label="Close"><i class="fa fa-close"></i></button>
            </div>
...
<div class="custom-modal-md custom-modal custom-modal-effect-1" id="customModal">
    <div class="custom-modal-content">
        ...
        <h5 class="custom-modal-title border-bottom text-center"><?php echo e(get_phrase('Loading...')); ?></h5>
...
<div class="alert-modal custom-modal custom-modal-effect-1" id="alertModal">
    <div class="custom-modal-content">
        ...
        <h6 class="custom-modal-title py-3"><?php echo e(get_phrase('Confirmation')); ?></h6>
        <div class="w-100 px-1 text-center pt-3 pb-4">
            <h6><?php echo e(get_phrase('Are you sure')); ?>?</h6>
            <a href="javascript:;" class="alert-cancel-btn btn btn-secondary mt-3 me-5 px-4"><?php echo e(get_phrase('Cancel')); ?></a>
            <a href="javascript:;" id="alertContinueLink" class="btn btn-primary mt-3 px-3"><?php echo e(get_phrase('Continue')); ?></a>
        </div>
    </div>
</div>
...
<?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/frontend/modal.blade.php ENDPATH**/ ?>