                    ...
                    <div class="col-lg-2 col-sm-4">
                        <div class="logo-branding">
                            ...
                            <a class="navbar-brand mt-2" href="<?php echo e(route('timeline')); ?>"><img
                                        ...
                                        class="logo_height_width" alt="logo" /><span class="logo-text -ml-3 d-block ml-2 text-uppercase"> Boqiy.uz </span></a>
                        </div>
                    </div>
...
<div class="mobile-header hide-on-tablet">
    <div class="balance-wrapper">
        <span>Balanse</span>
        <span id="mobile-balance">18172</span>
    </div>
    <div class="logo-wrapper"> 
        <a href="<?php echo e(route('allproducts')); ?>" class="text-white">
            DO'KON
        </a>
    </div>
    <div class="like-wrapper">
        <div><img src="<?php echo e(asset('assets/frontend/images/Like.png')); ?>" alt="Like" width="30" style=""></div>
        <div><?php echo e(number_format($likeBalance ? $likeBalance->balance : 0, 2)); ?></div>
    </div>
</div>
...
<script>
    ...
    </script><?php /**PATH /var/www/resources/views/frontend/header.blade.php ENDPATH**/ ?>