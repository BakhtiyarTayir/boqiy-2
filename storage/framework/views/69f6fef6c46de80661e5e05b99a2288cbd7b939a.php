<div class="product-details-wrap  p-3 radius-8 bg-white">
    <div class="product-header eProduct row">
        ...
        ?>
        <?php if($product->price_for_every_one > $userWalletBalance): ?>
            <div class="my-3">
        ...
        <?php endif; ?>
        <div class="col-lg-12">
            <img src="<?php echo e(route('showProductTypeFile', ['product_type_id' => $product->product_type_id])); ?>" alt="<?php echo e($product->name); ?>"
                ...
                <div class="col-lg-12">
                    <div class="eProduct_details">
                        <div class="product-info  np_info_pro">
                            ...
                            <del><span class="pt-price  sub-title"><?php echo e($product->price_for_every_one); ?> so'm</span></del>
                            <span style="color: firebrick" class="pt-price fa-lg sub-title ml-3"><?php echo e('O so\'m'); ?></span>
                            ...
                            <?php if(!$product->is_anonymous_sponsor): ?>
                                ...
                                <div class="pb-author align-items-center">
                                    <a href="<?php echo e(route('user.profile.view', $product->sponsor_id)); ?>">
                                        <img class="user_image_proifle_height" src="<?php echo e(route('showUserPhoto', $product->sponsor_id)); ?>" alt=""
                                             style="width: 30%; height: auto">
                                    </a>
                                    <div class="pb-info ms-2 mt-1">
                                        <a href="<?php echo e(route('user.profile.view', $product->sponsor_id)); ?>" class="h6">
                                ...
                                <?php if(!empty($telegram)): ?>
                                    <div class="my-2">
                                        <a href="<?php echo e($telegram); ?>" target="_blank" >
                                ...
                                <?php if(!empty($youtobe)): ?>
                                    <div class="my-2">
                                        <a href="<?php echo e($youtobe); ?>" target="_blank" >
                                ...
                                <?php if(!empty($site)): ?>
                                    <div class="my-2">
                                        <a href="<?php echo e($site); ?>" target="_blank" >
            ...
            <div class="row">
                <div class="n_detals_p pt-details <?php if(isset($_GET['shared'])): ?> hidden-on-shared-view <?php endif; ?>">
                    <h3 class="sub-title2"><?php echo e(get_phrase('Details')); ?></h3>
                    
                    <div class="product-description p_des mt-20">
                        <?php echo script_checker($product->text_for_every_one, false); ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row my-1 mt-2">
                ...
                <div class="product-comments s_comment2 bg-white">
                    <ul class="comment-wrap p-3 pt-0 pb-0 list-unstyled product-comment-list">
                                    ...
                                    <div class="avatar-info ms-2">
                                        <div class="comment-details n_comment_details">
                                            <div class="comment-content bg-secondary">
                                                ...
                                                <p class="mt-2 comment-img" data-img-url="<?php echo e(route('showProductCommentFile', ['comment_id' => 'comment_id'])); ?>">
                        ...
                        <?php if(!empty($product_comments) && count($product_comments)): ?>
                            <?php $__currentLoopData = $product_comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="comment-item n_comment_item mb-0 <?php if($loop->iteration > 3): ?> hide-comment-item d-none <?php endif; ?> ">
                                    <div class="d-flex justify-content-between mb-8">
                                        <div class="d-flex">
                                            <!-- Avatar -->
                                            <div class="">
                                            ...
                                            <div class="avatar-info ms-2">
                                                <div class="comment-details n_comment_details">
                                                    <div class="comment-content bg-secondary">
                                                        <h4 class="ava-nave"><?php echo e($comment->user_name); ?></h4>
                                                        <?php if($comment->type == \App\Models\ProductComment::TYPE_TEXT): ?>
                                                            <p><?php echo e($comment->text); ?></p>
                                                        <?php elseif($comment->type == \App\Models\ProductComment::TYPE_FILE): ?>
                                                            <p class="mt-2">
                                                                <img src="<?php echo e(route('showProductCommentFile', ['comment_id' => $comment->id])); ?>" alt="Rasm" style="max-width: 300px;">
                                                            </p>
                                                            <p class="mt-3"><?php echo e($comment->text); ?></p>
                                                        <?php endif; ?>
                                                    </div>
                                                    <p class="f-10 ml-3">
                                                        <?php echo e($comment->created_date); ?>
                    ...
                    <div class="d-flex align-items-center bg-secondary p-2 rounded-pill product-comment-input">
                        ...
                        <button type="button" id="send-message"
                                ...
                                data-url="<?php echo e(route('saveProductComment', ['product_id' => $product->id])); ?>"
                        >
        ...
        <?php if(!empty($related_product) && count($related_product)): ?>
                    ...
                    <div class="card m_product product">
                        <div class="product-figure position-relative mb-0">
                            <a href="<?php echo e(route('single.product', $related_product->id)); ?>">
                                <img src="<?php echo e(route('showProductTypeFile', ['product_type_id' => $related_product->product_type_id])); ?>"
                                     alt="<?php echo e($related_product->name); ?>" style="max-width: 100%; height: auto;">
                        ...
                        <div class="p-8">
                            <h3 class="h6">
                                <a href="<?php echo e(route('single.product',$related_product->id)); ?>"> <?php echo e(ellipsis($related_product->name, 15)); ?></a>
                                <?php if($related_product->is_sold): ?>
                                    <span class="badge bg-warning text-dark ml-2">Sovg‘a topshirilgan</span>
                                <?php endif; ?>
                            </h3>
...
<?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/frontend/marketplace/single_product.blade.php ENDPATH**/ ?>