<div class="home-header">
    <div class="row w-100 justify-content-between align-items-center">
      <div class="col-auto d-flex">
        ...
        <div class=" ms-4">
          <a href="<?php echo e(route('timeline')); ?>" class="btn btn-outline-primary" data-bs-toggle="tooltip" data-bs-title="<?php echo e(get_phrase('Visit Website')); ?>"><i class="bi bi-globe d-inline-block d-md-none"></i> <span class="d-md-inline-block d-none"><?php echo e(get_phrase('Visit Website')); ?></span></a>
        </div>
      </div>
            ...
            <li class="user-profile pe-2">
              <select class="form-control text-capitalize text-13px py-1 me-2" onchange="$(location).attr('href','<?php echo route('language.switch', ''); ?>/'+$(this).val());" style="margin-top: 7px;">
                <?php $__currentLoopData = get_all_language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($language->name); ?>" <?php if($language->name == Session('active_language')): ?> selected <?php endif; ?>><?php echo e($language->name); ?></option>
              ...
              <div class="btn-group">
                ...
                >
                  <div class="">
                    <img src="<?php echo e(get_user_image(auth()->user()->photo,'optimized')); ?>" height="42px" />
                  </div>
                  <div class="px-2 text-start">
                    <span class="user-name"><?php echo e(auth()->user()->name); ?></span>
                    <span class="user-title"><?php echo e(auth()->user()->user_role); ?></span>
                  </div>
                </button>
                <ul
                ...
                >
                  <li class="user-profile user-profile-inner">
                    ...
                    >
                      <div class="">
                        <img
                          class="radious-5px"
                          src="<?php echo e(get_user_image(auth()->user()->photo,'optimized')); ?>"
                          height="42px"
                        />
                      </div>
                      <div class="px-2 text-start">
                  ...
                  <li>
                    <a class="dropdown-item" href="<?php echo e(route('admin.system.settings.view')); ?>">
                      <span>
  ...
  </div><?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/backend/header.blade.php ENDPATH**/ ?>