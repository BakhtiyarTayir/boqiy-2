                    ...
                    <form action="<?php echo e(route('like_balance.process_topup')); ?>" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="amount" name="amount" value="<?php echo e(old('amount', 5000)); ?>" min="1000" step="1000" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <button type="button" class="btn btn-primary text-white amount-btn" data-amount="5000" data-text-class="text-for-5000">5000 <?php echo e(get_phrase('sum')); ?></button>
                                <button type="button" class="btn btn-outline-primary amount-btn" data-amount="10000" data-text-class="text-for-10000">10000 <?php echo e(get_phrase('sum')); ?></button>
                                <button type="button" class="btn btn-outline-primary amount-btn" data-amount="30000" data-text-class="text-for-30000">30000 <?php echo e(get_phrase('sum')); ?> <span class="badge bg-success">+5000</span></button>
                                <button type="button" class="btn btn-outline-primary amount-btn" data-amount="50000" data-text-class="text-for-60000">50000 <?php echo e(get_phrase('sum')); ?> <span class="badge bg-success">+15000</span></button>
                                <button type="button" class="btn btn-outline-primary amount-btn" data-amount="100000" data-text-class="text-for-120000">100000 <?php echo e(get_phrase('sum')); ?> <span class="badge bg-success">+20000</span></button>
                            </div>
                        </div>
                        <div>
...
<?php $__env->stopPush(); ?> <?php /**PATH D:\OSPanel\home\boqiy-a.local\public\resources\views/frontend/like_balance/topup.blade.php ENDPATH**/ ?>