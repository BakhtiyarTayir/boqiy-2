        ...
        <div class="single-dash-box">
           <div class="card colors-1">
              <div class="card-head d-flex justify-content-between align-items-center">
                  <p><?php echo e(get_phrase('Users')); ?></p>
              ...
              <div class="card-body d-flex justify-content-between">
                  ...
                  <div class="reader-count">
                      <h4><?php echo e(DB::table('users')->whereNot('user_role', 'admin')->count()); ?></h4>
                      <p><?php echo e(get_phrase('Total Users')); ?></p>
                  </div>
              </div>
           </div>
        </div>
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <div class="card colors-2">
              <div class="card-head d-flex justify-content-between align-items-center">
                  <p><?php echo e(get_phrase('Post')); ?></p>
                  <span><i class="bi bi-arrow-right"></i></span>
              </div>
              <div class="card-body d-flex justify-content-between">
                  <div class="reader-book">
                  ...
                  <div class="reader-count">
                      <h4><?php echo e(DB::table('posts')->get()->count()); ?></h4>
                      <p><?php echo e(get_phrase('Total Posts')); ?></p>
                  </div>
              </div>
           </div>
        </div>
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <div class="card colors-3">
              <div class="card-head d-flex justify-content-between align-items-center">
                  <p><?php echo e(get_phrase('Page')); ?></p>
                  <span><i class="bi bi-arrow-right"></i></span>
              </div>
              <div class="card-body d-flex justify-content-between">
                  <div class="reader-book">
                  ...
                  <div class="reader-count">
                      <h4><?php echo e(DB::table('pages')->get()->count()); ?></h4>
                      <p><?php echo e(get_phrase('Total Pages')); ?></p>
                  </div>
              </div>
           </div>
        </div>
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <div class="card colors-4">
              <div class="card-head d-flex justify-content-between align-items-center">
                  <p><?php echo e(get_phrase('Blog')); ?></p>
                  <span><i class="bi bi-arrow-right"></i></span>
              </div>
              <div class="card-body d-flex justify-content-between">
                  <div class="reader-book">
                  ...
                  <div class="reader-count">
                      <h4><?php echo e(DB::table('blogs')->get()->count()); ?></h4>
                      <p><?php echo e(get_phrase('Total Blogs')); ?></p>
                  </div>
              </div>
           </div>
        </div>
        ...
        <div class="single-dash-box">
           <div class="card colors-5">
              ...
              <div class="card-body d-flex justify-content-between">
                  ...
                  <div class="reader-count">
                      <h4><?php echo e(DB::table('sponsors')->get()->count()); ?></h4>
                      <p><?php echo e(get_phrase('Total Sponsored Posts')); ?></p>
                  </div>
              </div>
           </div>
        </div>
      ...
      <div class="col-md-6 col-lg-6 col-xl-4">
        <div class="single-dash-box">
           <div class="card colors-6">
              <div class="card-head d-flex justify-content-between align-items-center">
                  <p><?php echo e(get_phrase('Marketplace Products')); ?></p>
                  <span><i class="bi bi-arrow-right"></i></span>
              </div>
              <div class="card-body d-flex justify-content-between">
                  <div class="reader-book">
                  ...
                  <div class="reader-count">
                      <h4><?php echo e(DB::table('marketplaces')->get()->count()); ?></h4>
                      <p><?php echo e(get_phrase('Total Products')); ?></p>
                  </div>
              </div>
           </div>
        </div>
    ...
    var ctx1 = $("#visitors").get(0).getContext("2d");
      var myChart1 = new Chart(ctx1, {
          ...
          data: {
              ...
              datasets: [{
                      label: "<?php echo e(get_phrase('Number of user')); ?>",
                      data: [
...
<?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/backend/admin/dashboard/index.blade.php ENDPATH**/ ?>