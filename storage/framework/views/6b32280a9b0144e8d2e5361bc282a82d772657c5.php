        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="login-txt ms-s ms-lg-5">
                    <h3><?php echo e(get_phrase('Get Password Reset Link')); ?></h3>
                    <div class="mb-4 text-sm text-gray-600">
                        <?php echo e(get_phrase('Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.')); ?>

                    </div>
            
                    <!-- Session Status -->
                    <?php if(session('status')): ?>
                        <div class="alert alert-success"><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <input class="btn btn-primary my-3 py-2 rounded-10px p-10px" type="submit" value="<?php echo e(get_phrase('Email Password Reset Link')); ?>">
                            <a class="btn btn-primary my-3 py-2 w-100 rounded-10px p-10px" href="<?php echo e(route('login')); ?>"> <?php echo e(get_phrase('Back')); ?> </a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('auth.layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>