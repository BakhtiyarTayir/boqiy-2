...
<?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loopIndex => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="single-item-countable single-entry" id="postIdentification<?php echo e($post->post_id); ?>" data-post-id="<?php echo e($post->post_id); ?>" data-post-animation="<?php echo e($post->post_animation); ?>">
                ...
                <div class="entry-footer">
                    ...
                    <div class="footer-share d-flex justify-content-around">
                        ...
                        <span class="entry-react position-relative">
                            <a href="javascript:void(0)" class="gift-button" onclick="showLikesPanel(<?php echo e($post->post_id); ?>)">
                                <img width="19px" src="<?php echo e(asset('storage/images/gift-icon.svg')); ?>">
                                ...
                                <div class="likes-grid">
                                    ...
                                    <?php $__currentLoopData = $likes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $like): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="like-item" onclick="sendLike(<?php echo e($post->post_id); ?>, <?php echo e($like->id); ?>, <?php echo e($like->price); ?>)">
                                            <img src="<?php echo e($like->image_url); ?>" alt="<?php echo e($like->name); ?>">
                            ...
                            <ul class="react-list">
                                <li><a href="javascript:void(0)"
                                        onclick="myReact('post', 'like', 'update', <?php echo e($post->post_id); ?>)"><img
                                            src="<?php echo e(asset('storage/images/like.svg')); ?>" alt="Like"
                                            style="margin-right: 1px;"></a>
                                </li>
                                <li><a href="javascript:void(0)"
                                        onclick="myReact('post', 'love', 'update', <?php echo e($post->post_id); ?>)"><img
                                            src="<?php echo e(asset('storage/images/love.svg')); ?>" alt="Love"
                                ...
                                <li><a href="javascript:void(0)"
                                        onclick="myReact('post', 'angry', 'update', <?php echo e($post->post_id); ?>)"><img
                                            src="<?php echo e(asset('storage/images/angry.svg')); ?>" alt="Angry"></a>
                                </li>
                            </ul>
                        </span>
            ...
            <div class="comment-form d-flex pb-3">
                ...
                <form action="javascript:void(0)" class="w-100 ms-2" method="post">
                    <input class="form-control py-3"
                        ...
                        placeholder="<?php echo e(get_phrase('Write Comments')); ?>">
                </form>
            </div>
        </div>
...
<?php /**PATH /var/www/resources/views/frontend/main_content/posts.blade.php ENDPATH**/ ?>