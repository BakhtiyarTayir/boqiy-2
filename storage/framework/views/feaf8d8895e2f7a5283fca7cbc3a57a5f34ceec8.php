    ...
    <!--Javascript
        ...
        <script>
            ...
            $( document ).ready(function() {
                ...
                $('.register-page #name').val('');
                $('.register-page #phone').val('');
                $('.register-page #password').val('');
            });
        </script>
    </body>
    
    </html><?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/auth/layout/footer.blade.php ENDPATH**/ ?>