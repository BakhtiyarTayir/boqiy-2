...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		<?php echo $__env->yieldContent('specific_code_niceselect'); ?>
		<?php echo $__env->yieldContent('custom_js_code_for_page'); ?>
	...
	if (typeof jQuery !== 'undefined') {
			// Check if ajaxForm function is available
				...
				$('.ajaxForm:not(.initialized)').ajaxForm({
					...
					uploadProgress: function(event, position, total, percentComplete) {
						...
						if (percentComplete >= 100) {
							$('.ajaxForm .submitted:not(.no-processing)').html("<?php echo e(get_phrase('Processing')); ?>..");
						}
					},
	...
	$('.ajaxForm').on('submit', function(event){
		...
		$(this).find(':submit:not(.no-uploading)').html("<?php echo e(get_phrase('Uploading')); ?>..");
	...
	$("#searchblogfield").keyup(function(){
		...
		$.ajax({
			type : 'get',
			url : '<?php echo e(URL::to('/blog/search/')); ?>',
			headers: {
...
<?php echo $__env->yieldContent('custom_js_code_for_chat'); ?>
<?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/frontend/initialize.blade.php ENDPATH**/ ?>