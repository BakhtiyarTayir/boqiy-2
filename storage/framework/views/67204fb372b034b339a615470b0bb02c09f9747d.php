<div class="marketplace-wrap">
    <div class="product-form  mb-3 bg-white p-3 pb-12 radius-8">
        <div class="nm_place d-flex pagetab-head  align-items-center justify-content-between">
            <h3 class="h5"><span><i class="fa-solid fa-calendar-days"></i></span> <?php echo e(get_phrase('Homiylik')); ?></h3>
        </div>
    </div>
    <div class="card shadow p-4 mb-4 border-0 rounded-4">
        <div class="card-body">
            <h4 class="card-title mb-3 text-primary fw-bold">Homiylik – kelajak sari ezgu qadamingiz</h4>
            
            <p class="card-text">
                Farzandlarimiz orzularini ro‘yobga chiqarish uchun jamiyatning har bir a’zosi o‘z hissasini qo‘sha oladi.
                <span id="dots">...</span>
            </p>
            
            <div id="more" style="display: none;">
                <p class="card-text">
                    <strong>Do‘konimizdagi maxsus mahsulotlarga homiylik</strong> qilish orqali siz bolalarning ehtiyojlarini qondirishga,
                    ularning kelajagiga nur yo‘llashga sababchi bo‘lasiz.
                </p>
                <p class="card-text">
                    <strong>Tadbirkorlar</strong> uchun bu imkoniyat – nafaqat ezgulik, balki samarali reklama vositasidir.
                    Homiylik qilingan har bir mahsulot yonida sizning <em>kompaniyangiz</em> yoki <em>shaxsiy brendingiz</em> haqidagi
                    ma’lumotlar ham joylashtiriladi. Bu sizni <span class="text-success">ijtimoiy mas’uliyatli</span> shaxs sifatida tanitadi.
                </p>
                <p class="card-text">
                    Ota-onalar uchun esa bu – <strong>bolalar baxti yo‘lida haqiqiy mehr-muruvvat ifodasidir</strong>.
                </p>
                <p class="card-text">
                    <em>Tilanchilik emas, bu – ezgu niyat bilan qilingan amaliy yordam.</em> Qancha ko‘p inson qo‘l uzatsa,
                    shuncha ko‘p yurakda umid paydo bo‘ladi.
                </p>
                <p class="card-text">
                    Bir dona mahsulot – bir dona quvonch. Bugun siz sabab bo‘lgan tabassum – ertaga yurtimiz kelajagiga poydevor bo‘ladi.
                </p>
                <p class="card-text fw-semibold text-center mt-4 text-primary">
                    Ezgu ishda <u>sizni ham ko‘rishni istaymiz</u>.
                </p>
            </div>
            
            <span style="cursor:pointer;" class="mt-2" onclick="toggleText()" id="readMoreBtn">Ko‘proq o‘qish</span>
        </div>
    </div>
    ...
    <div class="product-listing bg-white radius-8 p-20 ">
        ...
        <div class="row g-3" id="<?php if(str_contains(url()->current(), '/productdata')): ?> single-item-countable <?php endif; ?>">
            <?php echo $__env->make('frontend.marketplace.sponsor_product_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <?php else: ?>
...
<?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/frontend/marketplace/sponsor_products.blade.php ENDPATH**/ ?>