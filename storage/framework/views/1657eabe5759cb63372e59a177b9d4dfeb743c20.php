        ...
        <div class="notify-inner shadow-sm">
                    ...
                    <?php $__currentLoopData = $new_notification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newNotification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($newNotification->type == 'event'): ?>
                            <li class="notify-item eventn-item">
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        <div class="noti-avata me-3"><img width="48" class="rounded-circle h-39"
                                                src="<?php echo e(get_user_image($newNotification->getUserData->id, 'optimized')); ?>"alt="">
                                            <span class="notify-type"><i class="fa fa-calendar"></i></span>
                                        </div>
                                        <div class="noti-details">
                                            <h4><a
                                                    href="<?php echo e(route('user.profile.view', $newNotification->getUserData->id)); ?>"><?php echo e(ucfirst($newNotification->getUserData->name)); ?></a><span>
                                                    <?php echo e(get_phrase('invited you to like')); ?> </span> <a
                                                    href="<?php echo e(route('single.event', $newNotification->getEventData->id)); ?>">
                                                    <?php echo e(ucfirst($newNotification->getEventData->title)); ?> </a> </h4>
                                            <?php if($newNotification->status == '0'): ?>
                                                <div class="btn-inline">
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        class="btn common_btn"><?php echo e(get_phrase('Accept')); ?></a>
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        class="btn btn-danger"><?php echo e(get_phrase('Decline')); ?></a>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                ...
                                <span
                                    class="noti-time"><?php echo e($newNotification->created_at->timezone(Auth::user()->timezone)->diffForHumans()); ?></span>
                            </li>

                            
                        <?php elseif($newNotification->type == 'fundraiser'): ?>
                            <li class="notify-item">
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        <div class="noti-avata me-3"><img width="48" class="rounded-circle h-39"
                                                src="<?php echo e(get_user_image($newNotification->getUserData->id, 'optimized')); ?>"
                                                alt="">
                                        ...
                                        <div class="noti-details">
                                            <h4><a
                                                    href="<?php echo e(route('user.profile.view', $newNotification->getUserData->id)); ?>"><?php echo e(ucfirst($newNotification->getUserData->name)); ?></a>
                                                <span><?php echo e(get_phrase('invited you to like')); ?> </span><a
                                                    href="<?php echo e(route('fundraiser.profile', $newNotification->getFundraiserData->id)); ?>">
                                                    <?php echo e(ucfirst($newNotification->getFundraiserData->title)); ?> </a>
                                ...
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        <div class="noti-avata me-3"><img width="48" class="rounded-circle h-39"
                                                src="<?php echo e(get_user_image($newNotification->getUserData->id, 'optimized')); ?>"
                                                alt="">
                                            <span class="notify-type"><i class="fa fa-users"></i></span>
                                        </div>
                                        <div class="noti-details">
                                            <h4><a
                                                    href="<?php echo e(route('user.profile.view', $newNotification->getUserData->id)); ?>"><?php echo e(ucfirst($newNotification->getUserData->name)); ?></a>
                                                <span><?php echo e(get_phrase('invited you to like')); ?> </span>
                                                <?php echo e(ucfirst($newNotification->getGroupData->title)); ?>
                                ...
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        ...
                                        <div class="noti-details">
                                            <h4> <a
                                                    href="<?php echo e(route('user.profile.view', $newNotification->getUserData->id)); ?>"><?php echo e(ucfirst($newNotification->getUserData->name)); ?></a>
                                                <span><?php echo e(get_phrase('sent you Friend Request')); ?>
                                ...
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        ...
                                        <div class="noti-details">
                                            <h4><a
                                                    href="<?php echo e(route('user.profile.view', $newNotification->getUserData->id)); ?>"><?php echo e(ucfirst($newNotification->getUserData->name)); ?></a><span>
                                                    <?php echo e(get_phrase('accepted Your Friend Request')); ?>
                                            ...
                                            <?php if($newNotification->status == '0'): ?>
                                                <div class="btn-inline">
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        class="btn common_btn"><?php echo e(get_phrase('Mark As Read')); ?></a>
                                                </div>
                                            <?php endif; ?>
                        ...
                        <?php elseif($newNotification->type == 'fundraiser_request_accept'): ?>
                            <li class="notify-item friendr-item">
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        <div class="noti-avata me-3"><img width="48" class="rounded-circle h-39"
                                        ...
                                        <div class="noti-details">
                                            <h4><a
                                                    href="<?php echo e(route('user.profile.view', $newNotification->getUserData->id)); ?>"><?php echo e(ucfirst($newNotification->getUserData->name)); ?></a><span>
                                                    <?php echo e(get_phrase('accepted Your campaign Request')); ?>
                                ...
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        ...
                                        <div class="noti-details">
                                            <h4><a
                                                    href="<?php echo e(route('user.profile.view', $newNotification->getUserData->id)); ?>"><?php echo e(ucfirst($newNotification->getUserData->name)); ?></a><span>
                                                    <?php echo e(get_phrase('accepted sYour Group Invitation Request')); ?>
                                ...
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        ...
                                        <div class="noti-details">
                                            <h4><a
                                                    href="<?php echo e(route('user.profile.view', $newNotification->getUserData->id)); ?>"><?php echo e(ucfirst($newNotification->getUserData->name)); ?></a><span>
                                                    <?php echo e(get_phrase('accepted Your Event Invitation Request')); ?>
            ...
            <div class="new-notif mt-4 pb-1">
                <?php if(count($older_notification) > 0): ?>
                    <h4 class="notify-title pb-1"><?php echo e(get_phrase('Earlier')); ?> <span><?php echo e(count($older_notification)); ?></span></h4>
                <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $older_notification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newNotification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php elseif(
                            $newNotification->type ==
                                'fundraiser_request_accept
                                                                                                                                                                            '): ?>
                            <li class="notify-item friendr-item">
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        <div class="noti-avata me-3"><img width="48" class="rounded-circle h-39"
                                                src="<?php echo e(get_user_image($newNotification->getUserData->id->id, 'optimized')); ?>"
                                                alt="">
                                            <span class="notify-type"><i class="fa fa-user"></i></span>
                                        </div>
                                        <div class="noti-details">
                                            <h4><a
                                                    href="<?php echo e(route('user.profile.view', $newNotification->getFundraiserData->id)); ?>"><?php echo e(ucfirst($newNotification->getUserData->name)); ?></a><span>
                                                    <?php echo e(get_phrase('accepted Your campaign invitation')); ?>
                                ...
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        ...
                                        <div class="noti-details">
                                            <h4><a
                                                    href="<?php echo e(route('user.profile.view', $newNotification->getUserData->id)); ?>"><?php echo e(ucfirst($newNotification->getUserData->name)); ?></a><span>
                                                    <?php echo e(get_phrase('accepted Your Group Invitation Request')); ?>
                        ...
                        <?php elseif($newNotification->type == 'event_invitation_accept'): ?>
                            <li class="notify-item friendr-item">
                                <div class="avatar-details">
                                    <div class="d-flex">
                                        <div class="noti-avata me-3"><img width="48" class="rounded-circle"
                                                src="<?php echo e(get_user_image($newNotification->getUserData->id, 'optimized')); ?>"
                                                alt="">
                                            <span class="notify-type"><i class="fa fa-user"></i></span>
                                        </div>
...
<?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/frontend/notification/notification.blade.php ENDPATH**/ ?>