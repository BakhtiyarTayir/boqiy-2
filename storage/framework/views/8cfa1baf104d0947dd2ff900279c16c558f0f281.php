	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="<?php echo e(route('like_balance.topup')); ?>" class="btn btn-primary">
					Hisobni to'ldirish
				</a>
...
</div><?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/modals/redirectLikeBalanceModal.blade.php ENDPATH**/ ?>