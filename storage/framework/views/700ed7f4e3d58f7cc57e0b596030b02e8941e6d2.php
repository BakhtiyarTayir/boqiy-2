...
<?php if(!empty($userData) && isset($post_react) && $post_react == true): ?>
...
<?php if(!empty($userData) && isset($ajax_call) && $ajax_call): ?>
    <!--hr tag will be split by js to show different sections-->
    <hr>
<?php endif; ?>

<?php if(!empty($userData) && isset($my_react) && $my_react == true): ?>
    <?php if(array_key_exists($userData->id, $user_reacts)): ?>
        <?php if($user_reacts[$userData->id] == 'like'): ?>
        ...
        <?php if($user_reacts[$userData->id] == 'love'): ?>
        ...
        <?php if($user_reacts[$userData->id] == 'haha'): ?>
            <div class="sad-color">
        ...
        <?php if($user_reacts[$userData->id] == 'angry'): ?>
        ...
        <?php if($user_reacts[$userData->id] == 'sad'): ?>
            <div class="sad-color">
...
<?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/frontend/main_content/post_reacts.blade.php ENDPATH**/ ?>