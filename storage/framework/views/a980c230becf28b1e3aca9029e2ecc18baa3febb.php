    ...
    <div class="row">
        <div class="col-12">
            <div class="eSection-wrap ">
                <form method="POST" action="<?php echo e($isUpdate ? route('admin.marketplace.free.products.update', ['id' => $freeProduct->id]) : route('admin.marketplace.free.products.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <select name="product_type_id" class="form-select eForm-control select2" <?php if($isUpdate): ?> disabled <?php endif; ?> required>
                                <?php
                                    $product_type_id = old('product_type_id') ?: ($isUpdate ? $freeProduct->product_type_id : null);
                                ?>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <select name="sponsor_id"
                                    ...
                                    <?php if($isUpdate && $freeProduct->is_payment_sponsor): ?>
                                    disabled
                                    <?php endif; ?>
                                    required>
                                <?php
                                    $sponsor_id = old('sponsor_id') ?: ($isUpdate ? $freeProduct->sponsor_id : null);
                                ?>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <select name="receiver_id"
                                    class="form-select eForm-control select2"
                                    <?php if($isUpdate && $freeProduct->is_sold): ?>
                                        disabled
                                    <?php endif; ?>
                            >
                                <option value="">Tanlanmadi</option>
                                <?php
                                    $receiver_id = old('receiver_id') ?: ($isUpdate ? $freeProduct->receiver_id : null);
                                ?>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <input class="form-control" type="number" min="1" step="1"  id="deadline_hour" name="deadline_hour"
                                   value="<?php echo e(old('deadline_hour') ?? ($freeProduct->deadline_hour ?? 36)); ?>">
                            <?php $__errorArgs = ['receiver_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                    ...
                    <div class="row mt-4 form-check my-4">
                        <div class="col-md-6 offset-2">
                            <input class="form-check-input" type="checkbox" name="is_active"
                                   id="is_active"
                                   value="1"
                                    <?php echo e(old('is_active', $freeProduct->is_active) ? 'checked' : ''); ?>>
...
<?php $__env->stopSection(); ?> <?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/backend/admin/marketplace/free_product_create.blade.php ENDPATH**/ ?>