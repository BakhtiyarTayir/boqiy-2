...
<!-- Main Start -->
<main class="main my-4 mt-12 no-login-page" style="max-height: 100%; overflow: auto">
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
			...
			<div class="col-lg-6 col-sm-12 order-3 order-lg-2">
				<div class="marketplace-wrap user_pro_market">
					<nav class="market-nav n_market_nav bg-white mb-12 radius-8">
						<div class="d-flex pagetab-head   align-items-center justify-content-between mb-12 py-2 px-3 ">
						...
						<div class="row g-3">
							<?php if(count($products)>0): ?>
								<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<div class="no-login-product col-6 col-md-4 col-lg-6 col-xl-4" id="product-<?php echo e($product->id); ?>">
										<div class="card m_product product">
											
											<a href="#" class="thumbnail-196-196 mb-2">
											...
											<div class="p-8 mt-4">
												<h3 class="h6"><a href="#"> <?php echo e(ellipsis($product->name, 30)); ?> </a></h3>
...
<script>
	$(document).ready(function() {
		setTimeout(function() {
			showRegisterModal();
		}, 5000); // 1000 millisekund = 5 sekund
	});
	
	$('.no-login-product').on('click', function (e) {
		showRegisterModal();
...
</script><?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/no-login-products.blade.php ENDPATH**/ ?>