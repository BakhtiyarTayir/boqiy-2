<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li class="nav-links-li <?php if(
                ...
                Route::currentRouteName() == 'admin.marketplace.products.featured' ||
                Route::currentRouteName() == 'admin.marketplace.products.out-of-stock' ||
                Route::currentRouteName() == 'admin.marketplace.orders' ||
                Route::currentRouteName() == 'admin.marketplace.orders.pending' ||
                Route::currentRouteName() == 'admin.marketplace.orders.cancelled' ||
                Route::currentRouteName() == 'admin.marketplace.statistics' ||
                Route::currentRouteName() == 'admin.marketplace.order.show'): ?> showMenu <?php endif; ?>">
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
            ...
            <ul class="sub-menu">
                <li>
                    <a class="<?php if(Route::currentRouteName() == 'admin.marketplace.products' ||
                                Route::currentRouteName() == 'admin.marketplace.products.show' ||
                                Route::currentRouteName() == 'admin.marketplace.products.edit'): ?> Active <?php endif; ?>"
                       href="<?php echo e(route('admin.marketplace.products')); ?>"><?php echo e(get_phrase('Products')); ?></a>
                </li>
                <li>
                    <a class="<?php if(Route::currentRouteName() == 'admin.marketplace.free.products'): ?> Active <?php endif; ?>"
                       href="<?php echo e(route('admin.marketplace.free.products')); ?>"><?php echo e(get_phrase('Free Products')); ?></a>
                </li>
                <li>
                    <a class="<?php if(Route::currentRouteName() == 'admin.marketplace.products.featured'): ?> Active <?php endif; ?>"
                       href="<?php echo e(route('admin.marketplace.products.featured')); ?>"><?php echo e(get_phrase('Active Products')); ?></a>
                </li>
                <li>
                    <a class="<?php if(Route::currentRouteName() == 'admin.marketplace.products.out-of-stock'): ?> Active <?php endif; ?>"
                       href="<?php echo e(route('admin.marketplace.products.out-of-stock')); ?>"><?php echo e(get_phrase('Out of Stock Products')); ?></a>
                </li>
                <li>
                    <a class="<?php if(Route::currentRouteName() == 'admin.marketplace.orders' ||
                                Route::currentRouteName() == 'admin.marketplace.order.show'): ?> Active <?php endif; ?>"
                       href="<?php echo e(route('admin.marketplace.orders')); ?>"><?php echo e(get_phrase('Orders')); ?></a>
                </li>
                <li>
                    <a class="<?php if(Route::currentRouteName() == 'admin.marketplace.orders.pending'): ?> Active <?php endif; ?>"
                       href="<?php echo e(route('admin.marketplace.orders.pending')); ?>"><?php echo e(get_phrase('Pending Orders')); ?></a>
                </li>
                <li>
                    <a class="<?php if(Route::currentRouteName() == 'admin.marketplace.statistics'): ?> Active <?php endif; ?>"
                       href="<?php echo e(route('admin.marketplace.statistics')); ?>"><?php echo e(get_phrase('Sales Statistics')); ?></a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-links-li <?php if(Route::currentRouteName() == 'admin.about.page.data.view' ||
            ...
            <ul class="sub-menu">
                ...
                <li><a class="<?php if(Route::currentRouteName() == 'admin.import.translations'): ?> Active <?php endif; ?>"
                       href="<?php echo e(route('admin.import.translations')); ?>"><?php echo e(get_phrase('Import Translations')); ?></a></li>
...
<?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/backend/admin/sidebar.blade.php ENDPATH**/ ?>