...
<main class="main my-4 mt-12">
    <div class="container">
        <div class="row">
            ...
            <?php else: ?>
                <div class="col-lg-3">
                    <div style="position: sticky; top: 80   px">
...
<?php if(session('showWelcomeBonusModal') == 1): ?>
    <?php echo $__env->make('modals.welcomeBonusModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
...
<!-- Likes System JS -->
<script src="<?php echo e(asset('assets/frontend/js/likes.js')); ?>"></script>
...
<script>
    $(document).ready(function() {
        // Bootstrap 5 Modal obyektini olish
        var modal = new bootstrap.Modal(document.getElementById('welcomeBonusModal'));
        modal.show();
    });
</script>
<?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/frontend/index.blade.php ENDPATH**/ ?>