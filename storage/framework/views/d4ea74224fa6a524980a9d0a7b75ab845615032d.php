            ...
            <div class="row">
                <div class="col-lg-2 col-sm-4">
                    <div class="logo-branding">
                        ...
                        ?>
                        <a class="navbar-brand mt-2" href="<?php echo e(route('timeline')); ?>">
                            <?php if(0): ?>
                        ...
                        <div class="sc-search">
                            <form action="<?php echo e(route('search')); ?>" method="GET" id="form_id">
                                ...
                                <input type="search"  class="rounded white-placeholder hashtag-link" name="search"
                                       ...
                                       placeholder="<?php echo e(get_phrase('Search')); ?>">
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="align-items-center d-flex justify-content-end g-12">
                            ...
                            <div class="profile-control dropdown">
                                <button class="dropdown-toggle" type="button" id="dropdownMenuButton1"
                                    ...
                                    <img src="<?php echo e(route('showUserPhoto', auth()->user()->id)); ?>"
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li class="dropdown-item d-none">
                                        <div class="d-flex align-items-center">
                                            <span class="me-2"><?php echo e(get_phrase('Language')); ?>:</span>
                                            <select class="form-select form-select-sm" onchange="$(location).attr('href', '<?php echo e(route('language.switch', '')); ?>/' + $(this).val());">
                                                <option value="en" <?php echo e(Session('active_language') == 'en' ? 'selected' : ''); ?>>English</option>
                                                <option value="uz" <?php echo e(Session('active_language') == 'uz' ? 'selected' : ''); ?>>O'zbekcha</option>
                                            </select>
                                        </div>
                                    </li>
...
<div class="mobile-header hide-on-tablet">
    <div class="balance-wrapper">
        ...
        <span id="mobile-balance">
            <?php echo e($userWallet? $userWallet->balance : 0); ?>

        </span>
    </div>
    <div class="logo-wrapper">
        <a href="<?php echo e(route('allproducts')); ?>" class="text-white2">
            <span class="element-pulse text-white"><?php echo e(get_phrase('Marketplace')); ?></span>
        </a>
    </div>
    <div class="like-wrapper">
        ...
        <div><?php echo e($userLikeBalance ? $userLikeBalance->balance : 0); ?></div>
    </div>
</div>
...
</script><?php /**PATH /home/asilbek/Downloads/boqiy-uz/boqiy.uz-master/web/resources/views/frontend/header.blade.php ENDPATH**/ ?>