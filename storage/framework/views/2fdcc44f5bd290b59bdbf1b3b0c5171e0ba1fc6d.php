                ...
                <ul>
                    ...
                    <li class="<?php if(Route::currentRouteName() == 'wallet.index' || Route::currentRouteName() == 'wallet.transactions'): ?> active <?php endif; ?>">
                        <a href="<?php echo e(route('wallet.index')); ?>">
                            <img src="<?php echo e(asset('storage/images/Verify.png')); ?>" alt="Wallet"><?php echo e(get_phrase('Wallet')); ?>

                        </a>
                    </li>
                    <li class="<?php if(Route::currentRouteName() == 'like_balance.index' || Route::currentRouteName() == 'like_balance.transactions'): ?> active <?php endif; ?>">
                        <a href="<?php echo e(route('like_balance.index')); ?>">
                            <img src="<?php echo e(asset('storage/images/gift.svg')); ?>" alt="Like Balance"><?php echo e(get_phrase('Like Balance')); ?>
...
<?php /**PATH /var/www/resources/views/frontend/left_navigation.blade.php ENDPATH**/ ?>