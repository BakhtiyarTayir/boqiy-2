<div class="mobile-navigation">
    ...
    <div>
        <a href="<?php echo e(route('like_balance.index')); ?>">
            <img src="<?php echo e(asset('assets/frontend/images/Like.png')); ?>" alt="Like" width="30" style="">
            <span><?php echo e(number_format($likeBalance ? $likeBalance->balance : 0, 2)); ?></span>
        </a>
    </div>
    <div class="d-none">
        <select class="form-select form-select-sm py-0 px-1" style="max-width: 80px;" 
                onchange="$(location).attr('href', '<?php echo e(route('language.switch', '')); ?>/' + $(this).val());">
            <option value="en" <?php echo e(Session('active_language') == 'en' ? 'selected' : ''); ?>>EN</option>
            <option value="uz" <?php echo e(Session('active_language') == 'uz' ? 'selected' : ''); ?>>UZ</option>
        </select>
    </div>
    <div>
        <a href="<?php echo e(route('allproducts')); ?>">
            <img src="<?php echo e(asset('/assets/frontend/images/sponsor.png')); ?>" width="30" alt="homiylik">
...
<?php /**PATH /var/www/resources/views/frontend/mobile_navigation.blade.php ENDPATH**/ ?>